...
def dashboard(request: HttpRequest):
    ...
    # Метод select_related() поможет повышать производительность 
    # при извлечении связанных объектов во взаимосвязях один-ко-многим
...
def register(request: HttpRequest):
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            ...
            )  # в целях безопасности (метод хеширует пароль)
            new_user.save()
